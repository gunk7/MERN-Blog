...
const AdminLayout = () => {
  ...
  const NavContent = ({ isMobile = false }) => (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="px-2 py-4 border-t border-surface-highest/60 bg-white">
        {!collapsed || isMobile ? (
          <div className="flex items-center gap-3 mb-3 px-1 animate-in fade-in duration-300">
  ...
  return (
    <div className="h-screen bg-surface flex flex-col md:flex-row overflow-hidden">
      ...
      <aside
        className={`
    hidden md:flex bg-white border-r border-surface-highest/60 flex-col shrink-0
